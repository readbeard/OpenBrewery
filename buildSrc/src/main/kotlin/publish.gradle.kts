        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/readbeard/openbrewery/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/readbeard/openbrewery.git")
                        developerConnection.set("scm:git:ssh://github.com/readbeard/openbrewery.git")
                        url.set("https://github.com/readbeard/openbrewery/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/readbeard/openbrewery/issues")
                    }
                }
            }
        }
